document.getElementById('player1-score').textContent = 'Player 1 : 0'
        ...
        function startNewGame() {
            ...
            document.getElementById('player2-score').textContent = document.getElementById("edit-player-2-btn").textContent + ' : ' + player2Score
            document.getElementById('player1-score').textContent = document.getElementById("edit-player-1-btn").textContent + ' : ' +player1Score
            resetGameStatus();
...
function updateScoreboard() {
    ...
    document.getElementById('player1-score').textContent = `${nm}: ${player1Score}`;
    document.getElementById('player2-score').textContent = `${nm2}: ${player2Score}`;
...
function endGame(winnerId) {
    ...
    updateScoreboard(); // Update the scoreboard after each game
}
